          ...
          <div style={{ width: '70vw', margin: '0 auto', marginTop: '2vh' }}>
            ...
            <Table onRow={(record, rowIndex) => {
              ...
              <ColumnGroup title="Goals">
                <Column title="Home Goals" dataIndex="HomeGoals" key="HomeGoals" sorter= {(a, b) => a.FullTimeGoalsH.localeCompare(b.FullTimeGoalsH)}/>
                <Column title="Away Goals" dataIndex="AwayGoals" key="AwayGoals" sorter= {(a, b) => a.FullTimeGoalsA.localeCompare(b.FullTimeGoalsA)}/>
              </ColumnGroup>
